...
require("lazy").setup({
	...
	-- Fuzzy finding and File explorer
	{
		...
		config = function()
			...
			-- Use FzfLua as default file explorer
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>ld", require("fzf-lua").lsp_document_symbols, "[L]SP [D]ocument Symbols")

					-- Fuzzy find all the symbols in your current workspace.
					--  Similar to document symbols, except searches over your entire project.
					map("<leader>lw", require("fzf-lua").lsp_live_workspace_symbols, "[L]SP [W]orkspace Symbols")
